...
// import PinsidebarModal from "./PinsidebarModal";
...
//   const [PinsidebarModalOpen, setPinsidebarModalOpen] = useState(false);
...
// <div className="p-2">
//       <div 
//         className="text-gray-500 text-xs flex items-center cursor-pointer hover:text-white"
//         onClick={() => setPinsidebarModalOpen(true)}
//       >
//         <Plus size={14} />
//         <span className="ml-1">Pin to sidebar</span>
//       </div>
//       {PinsidebarModalOpen && (
//         <PinsidebarModal onClose={() => setPinsidebarModalOpen(false)} />
//       )}
//     </div>
...
//                         console.log("Selected organization ID:",org._id);
//                       }}                    
//                     />
//                   </div>
//                 )}
                ...
                {openTeams[org.name] && (
                  <div className="ml-4 mt-1 space-y-1">
                    ...
                    <SidebarItem
                      text="Inbox"
                      icon={<CheckSquare size={16} />}
                      active={selectedTab === `${org.name}-OrgInbox`}
                      onClick={() => handleSelectTab(`${org.name}-OrgInbox`)}
                    />
                    <SidebarItem
                      text="Task"
                      icon={<CheckSquare size={16} />}
